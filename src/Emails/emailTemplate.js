export const emailTempalte = (email) => {
  return `<!DOCTYPE html>
														...
														<tr>
															<td class="pad" style="padding-bottom:10px;padding-left:40px;padding-right:40px;padding-top:10px;">
																<div style="color:#555555;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-size:15px;line-height:150%;text-align:center;mso-line-height-alt:22.5px;">
																	<p style="margin: 0; word-break: break-word;"><span style="word-break: break-word; color: #808389;">Please Verify Your Account For More Pros</span></p>
																</div>
															</td>
														</tr>
													</table>
														...
														<tr>
															<td class="pad" style="padding-bottom:10px;padding-left:40px;padding-right:40px;padding-top:15px;">
																<div style="color:#555555;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-size:12px;line-height:150%;text-align:left;mso-line-height-alt:18px;">
																	<p style="margin: 0; word-break: break-word;"><span style="word-break: break-word; color: #95979c;">The Code Sender Project is an innovative application designed to support student learning by sending daily code snippets to users. This project aims to enhance coding skills and knowledge by providing a steady stream of educational content directly to students' inboxes. Whether it's a new algorithm, a programming tip, or a small coding challenge, the Code Sender ensures that students receive valuable and relevant coding examples every day..</span></p>
																</div>
															</td>
														</tr>
													</table>
